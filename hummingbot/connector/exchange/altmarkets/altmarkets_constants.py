...
class Constants:
    ...
    REST_URL = "https://www.quarkx.pro/api/v2/peatio"
    WS_PRIVATE_URL = "wss://www.quarkx.pro/api/v2/ranger/private"
    WS_PUBLIC_URL = "wss://www.quarkx.pro/api/v2/ranger/public"
